...
public class ResultInterfaceF extends JFrame {
    private long startTime;
    private long endTime;

    public ResultInterfaceF(long startTime, long endTime) {
        ...
        JLabel centerLabel = new JLabel("실패");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ResultInterfaceF(System.currentTimeMillis(), System.currentTimeMillis() + 5000));
    }
}